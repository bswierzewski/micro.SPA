...
@Component({
  selector: 'app-settings-device-address',
  templateUrl: './settings-device-address.component.html',
  styleUrls: ['./settings-device-address.component.scss'],
})
export class SettingsDeviceAddressComponent implements OnInit, OnDestroy, AfterViewInit {
