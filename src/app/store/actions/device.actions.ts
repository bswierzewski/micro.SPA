...
export const loadDeviceError = createAction('[Device] Load Device Error', props<{ error: any }>());
...
export const deleteDeviceError = createAction('[Device] Delete Device Error', props<{ error: any }>());
...
export const addDeviceError = createAction('[Device] Add Device Error', props<{ error: any }>());
...
export const updateDeviceError = createAction('[Device] Update Device Error', props<{ error: any }>());
