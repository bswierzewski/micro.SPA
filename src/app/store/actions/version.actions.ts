...
export const loadVersionsError = createAction('[Version] Load Versions Error', props<{ error: any }>());
...
export const loadVersionError = createAction('[Version] Load Version Error', props<{ error: any }>());
...
export const deleteVersionError = createAction('[Version] Delete Version Error', props<{ error: any }>());
...
export const addVersionError = createAction('[Version] Add Version Error', props<{ error: any }>());
...
export const updateVersionError = createAction('[Version] Update Version Error', props<{ error: any }>());
