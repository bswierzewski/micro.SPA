...
export const loadCategoryError = createAction('[Category] Load Category Error', props<{ error: any }>());
...
export const addCategoryError = createAction('[Category] Add Category Error', props<{ error: any }>());
...
export const updateCategoryError = createAction('[Category] Update Category Error', props<{ error: any }>());
