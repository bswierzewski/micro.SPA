...
export const loadKindError = createAction('[Kind] Load Kind Error', props<{ error: any }>());
...
export const deleteKindError = createAction('[Kind] Delete Kind Error', props<{ error: any }>());
...
export const addKindError = createAction('[Kind] Add Kind Error', props<{ error: any }>());
...
export const updateKindError = createAction('[Kind] Update Kind Error', props<{ error: any }>());
